...
VALUES
(1, 'Anko Malbec', 'Aromas florales y especiados, sabores a frutas negras, fácil de tomar, muy bien balanceado.', "anko-malbec.jpg", 1200, 1, 0),
(2, 'Manos Negras', 'El Malbec es indiscutiblemente, la uva emblemática de Argentina. El oasis desértico de altitud de Mendoza ha proporcionado las condiciones ideales para que esta uva despliegue sus puntos fuertes como en ningún otro lugar del mundo. Los días de sol brillante dan un color negruzco y sabores de fruta oscura, mientras que las noches frescas de la montaña producen aromas a violeta y una textura suave y flexible.', "manos-negras-malbec1-.png", 1145, 1, 15),
(3, 'Prodigo - Torrontes', 'De color amarillo cristalino. En nariz se detectan aromas intensos a frutos cítricos, flores de naranja y jazmín. En boca se presenta muy aromático con finas notas minerales y agradable acidez. Persistente y elegante final. Sugerencias gastronómicas: Se presta para acompañar con “carpaccio” y comida oriental. Ideal con platos a base de langostinos y centolla.', "prodigo-torrontes1.png", 646, 2, 0),
(4, 'Anko - Torrontes', 'Aromas florales, principalmente jazmín. Perfil de cítricos en compañía de una acidez natural que le dan un acabado brillante y limpio.', "anko-torrontes1.jpg", 896, 2, 15),
(5, 'Saurus Pinot Noir', 'Es un vino del estilo de la Provence, región del sur de Francia reconocida por ser la cuna de los rosé más prestigiosos, de un perfil que expresa suavidad y frescura. Su delicado color rosa pálido está asociado a la elaboración de maceración corta. Se destaca su viva acidez, fluidez y amabilidad. Fácil de beber.', "saurus-estate-pinot-rose.png", 750, 3, 0),
(6, 'Taymante - Tardio', 'Color: Amarillo-dorado (miel). Aromas: a frutos tropicales y cítricos. Temperatura: beberse a 7ºC en copa tipo jerez.', "taymante-tardio.jpg", 650, 4, 0),
(7, 'antigal uno sauvignon blanc', 'La dulzura y el cuerpo de este vino dan sensación de felicidad', "antigal uno sauvignon blanc.jpg", 1000, 4, 10),
